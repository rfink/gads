...
type KeywordCriterion struct {
	Id        int64  `xml:"https://adwords.google.com/api/adwords/cm/v201802 id,omitempty"`
	Text      string `xml:"https://adwords.google.com/api/adwords/cm/v201802 text,omitempty"`      // Text: up to 80 characters and ten words
	MatchType string `xml:"https://adwords.google.com/api/adwords/cm/v201802 matchType,omitempty"` // MatchType:  "EXACT", "PHRASE", "BROAD"
}

// https://developers.google.com/adwords/api/docs/reference/v201802/AdGroupExtensionSettingService.Keyword
// Represents a keyword.
type Keyword struct {
	Id            int64         `xml:"https://adwords.google.com/api/adwords/cm/v201802 id,omitempty"`
	Type          CriterionType `xml:"https://adwords.google.com/api/adwords/cm/v201802 type,omitempty"`
	CriterionType CriterionType `xml:"https://adwords.google.com/api/adwords/cm/v201802 Criterion.Type,omitempty"`

	Text      string           `xml:"https://adwords.google.com/api/adwords/cm/v201802 text,omitempty"`
	MatchType KeywordMatchType `xml:"https://adwords.google.com/api/adwords/cm/v201802 matchType,omitempty"`
}

// https://developers.google.com/adwords/api/docs/reference/v201802/AdGroupExtensionSettingService.KeywordMatchType
// Match type of a keyword. i.e. the way we match a keyword string with search queries.
// EXACT, PHRASE, BROAD
type KeywordMatchType string

// https://developers.google.com/adwords/api/docs/reference/v201802/AdGroupExtensionSettingService.Criterion.Type
// The types of criteria
type CriterionType string

// https://developers.google.com/adwords/api/docs/reference/v201802/AdGroupExtensionSettingService.LocationTargetingStatus
...
type LanguageCriterion struct {
	Id   int64  `xml:"https://adwords.google.com/api/adwords/cm/v201802 id,omitempty"`
	Code string `xml:"https://adwords.google.com/api/adwords/cm/v201802 code,omitempty"`
	Name string `xml:"https://adwords.google.com/api/adwords/cm/v201802 name,omitempty"`
}

// https://developers.google.com/adwords/api/docs/reference/v201802/AdGroupExtensionSettingService.Location
...
type Location struct {
	...
	LocationName    string                  `xml:"https://adwords.google.com/api/adwords/cm/v201802 locationName,omitempty"`
	DisplayType     string                  `xml:"https://adwords.google.com/api/adwords/cm/v201802 displayType,omitempty"`
	TargetingStatus LocationTargetingStatus `xml:"https://adwords.google.com/api/adwords/cm/v201802 targetingStatus,omitempty"`
	ParentLocations []Location              `xml:"https://adwords.google.com/api/adwords/cm/v201802 parentLocations,omitempty"`
}
